...
public abstract class Enemy extends Mob {
	 ...
	 */
	@Override
	public void calculateMove() throws Exception {
		int xa = 0, ya = 0;
		if(_steps <= 0){
	...
	@Override
	public boolean canMove(double x, double y) throws Exception {
