...
import com.subarashi.bomberman.entities.tile.destroyable.DestroyableTile;
...
public class LayeredEntity extends Entity {
	...
	public LayeredEntity(int x, int y, Entity ... entities) { // dấu 3 chaams là khi truyền đối số là mảng hay kiểu đơn cũng đc hay để trống cũng đc
		_x = x;
		_y = y;
