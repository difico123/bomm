...
public class Game extends Canvas {
	...
	public static final int TILES_SIZE = 16,
							WIDTH = TILES_SIZE * 30, //minus one to ajust the window,
	...
	//initial configs
	private static final int BOMBRATE = 5;
	...
	public Game(Frame frame) throws Exception {
		_frame = frame;
	...
	private void renderGame() { //render will run the maximum times it can per second
		...
		screen.clear(); // cái này cho mỗi phần từ của pixcel = 0
